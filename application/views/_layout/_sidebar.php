    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li <?php if ($page == 'unit_pendidikan') {echo 'class="active"';} ?>>
          ...
          <li <?php if ($page == 'tipe_pembayaran') {echo 'class="active"';} ?>>
      ...
      <li <?php if ($page == 'kelas_siswa') {echo 'class="active"';} ?>>
      ...
      <li <?php if ($page == 'panduan_admin') {echo 'class="active"';} ?>>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li <?php if ($page == 'pendaftaran') {echo 'class="active"';} ?>>
            <a href="<?php echo base_url('Pendaftaran'); ?>">
              <i class="fa fa-users"></i>
              <span>Data Pendaftaran</span>
            </a>
          </li>
          <li <?php if ($page == 'setting_pembayaran') {echo 'class="active"';} ?>>
            <a href="<?php echo base_url('Setting_pembayaran_psb'); ?>">
              <i class="glyphicon glyphicon-cog"></i>
              <span>Setting Pembayaran PPDB</span>
            </a>
          </li>
          <li <?php if ($page == 'pembayaran') {echo 'class="active"';} ?>>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li <?php if ($page == 'laporan_kelas_siswa') {echo 'class="active"';} ?>>
      ...
      <li <?php if ($page == 'panduan_user') {echo 'class="active"';} ?>>
        <a href="<?php echo base_url('Panduan'); ?>">
            <i class="glyphicon glyphicon-info-sign"></i>
            <span>Panduan</span>
        </a>
