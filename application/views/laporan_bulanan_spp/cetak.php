<div class="box">
    ...
    <div class="box-body" style="overflow-x: auto;">
        <?php
        $up = $this->db->get_where('unit_pendidikan', ['id_unit_pendidikan' => $_GET['unit_pendidikan']])->row_array();
        $ta = $this->db->get_where('tahun_ajaran', ['id_tahun_ajaran' => $_GET['tahun_ajaran']])->row_array();
